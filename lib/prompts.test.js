...
describe('promptLab', () => {
    ...
    it('should return multiple runs for comma-separated profiles', async () => {
        const result = await prompts.promptLab('https://example.com', { profile: 'low,high', network: undefined, device: undefined });
    ...
    it('should expand "all" to 4 runs', async () => {
        const result = await prompts.promptLab('https://example.com', { profile: 'all', network: undefined, device: undefined });
    ...
    it('should return custom run when only network/device flags provided', async () => {
        const result = await prompts.promptLab('https://example.com', { profile: undefined, network: '3g', device: 'iphone-12' });
