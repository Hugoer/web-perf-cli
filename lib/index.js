...
module.exports = {
    ...
    /** @returns {typeof import('./psi').PSI_MAX_REQUESTS_PER_SECOND} */
    get PSI_MAX_REQUESTS_PER_SECOND() {
        return psi().PSI_MAX_REQUESTS_PER_SECOND;
    },
    /** @returns {typeof import('./crux').CRUX_MAX_REQUESTS_PER_SECOND} */
    get CRUX_MAX_REQUESTS_PER_SECOND() {
        return crux().CRUX_MAX_REQUESTS_PER_SECOND;
    },
    /** @returns {typeof import('./crux-history').CRUX_HISTORY_MAX_REQUESTS_PER_SECOND} */
    get CRUX_HISTORY_MAX_REQUESTS_PER_SECOND() {
        return cruxHistory().CRUX_HISTORY_MAX_REQUESTS_PER_SECOND;
    },
};
