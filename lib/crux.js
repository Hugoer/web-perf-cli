 ...
 *
 * @typedef {import('./crux-client').CruxAuditOptions} CruxAuditOptions
 * @typedef {import('./crux-client').CruxRunOptions} CruxRunOptions
 * @typedef {import('./crux-client').CruxBatchOptions} CruxBatchOptions
 */
