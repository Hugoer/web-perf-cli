...
async function runLabAudit(url, labOptions = {}) {
    const [{ default: chromeLauncher }, { default: lighthouse }] = await Promise.all([
...
module.exports = { runLab, runLabAudit, buildLighthouseConfig, CHROME_FLAGS, DEFAULT_SKIP_AUDITS };
